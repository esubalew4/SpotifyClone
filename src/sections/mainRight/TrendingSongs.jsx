      ...
      >
        {trending_songs.map((track) => (
          <Link key={track.id} to={`/song/${track.id}`}>
            <div className="group flex flex-col p-4 cursor-pointer hover:bg-gradient-to-t from-primary via-primary to-transparent rounded-md duration-150 h-fit max-w-44">
              {/*cover box */}
