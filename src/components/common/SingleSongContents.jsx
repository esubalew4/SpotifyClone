...
import SpecificArtistSongs from "./SpecificArtistSongs";
import SelectedPopular from "../../sections/songs/SelectedPopular";
import MainRightFooter from "../../sections/mainRight/MainRightFooter";

const SingleSongContents = ({ item }) => {
        ...
        <div className="flex gap-6 pb-40 items-end bg-gradient-to-t from-transparent via-amber-900 via-40% to-yellow-300 py-8 px-6">
          ...
          <div className="font-bold text-sm flex flex-col gap-3">
            <div className="flex gap-4 items-center">
              <p className="text-text-p">single</p>
              <p className="text-text-p bg-blue-600 px-2 py-1 rounded-sm shadow/30">
...
export default SingleSongContents;
